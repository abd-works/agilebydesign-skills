...
A validated learning backlog item passes when it names who owns the test and what action they will take — the Plan step identifies the method (research, conversation, prototype, pilot, etc.) and scope. Failing means a backlog row exists with no named owner or no stated method, leaving the experiment undeclared and unscheduled.
