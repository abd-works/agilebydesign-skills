...
| #   | Step          | Actor | Script                | What it does                                                                   | Coverage   | Ref                       | Inputs                         | Outputs             |
| --- | ------------- | ----- | --------------------- | ------------------------------------------------------------------------------ | ---------- | ------------------------- | ------------------------------ | ------------------- |
| 9   | **Evidence**  | Code  | TBD (not implemented) | Mine complete context for actions, decisions, states, relationships            | All chunks | [evidence (built)](steps/built/evidence.md)   | map-model-spec.json, context/  | evidence/*.json     |
| 10  | **Structure** | AI    | —                     | Finalize Map & model and build steps, scenarios, examples from evidence        | —          | [structure (built)](steps/built/structure.md) | map-model-spec.json, evidence/ | map-model-spec.json |
| 11  | **Finalize**  | AI    | —                     | Assign operations; link behaviors; split by subtype; fix anti-patterns; assess | —          | [finalize (built)](steps/built/finalize.md)   | map-model-spec.json            | map-model-spec.json |


**Built step specs (agents):** [context](context.md), [modules-epics-foundational-spine](steps/built/modules-epics-foundational-spine.md), [modules-epics-scaffold-breadth](steps/built/modules-epics-scaffold-breadth.md), [concept-classification](steps/built/concept-classification.md), [concept-classes-stories](steps/built/concept-classes-stories.md), [integrate-harmonize](steps/built/integrate-harmonize.md), [evidence](steps/built/evidence.md), [structure](steps/built/structure.md), [finalize](steps/built/finalize.md). Edit **`parts/steps/<name>.md`**, then **`python scripts/build.py`** (regenerates `parts/steps/built/` and `AGENTS.md`).
