...
| --- | -------------------------- | -------------- | ----------------- | -------------------------------------------------- |
| 1   | Discovery → Prioritization | SSO surface    | Per-slice         | Map integration surface and capture unknowns       |
| 2   | Exploration → Engineering  | Thin slice 1   | Per-slice         | Prove spec → test → code against Acme SSO         |
