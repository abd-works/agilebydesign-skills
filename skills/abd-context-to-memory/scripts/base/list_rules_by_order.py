...
Usage: python scripts/base/list_rules_by_order.py [--tag TAG]  # filter to rules with TAG in tags"""
import re
import sys
...
if not rules_dir.is_dir():
    print("[INFO] No rules/ directory — nothing to list.", file=sys.stderr)
    sys.exit(0)
