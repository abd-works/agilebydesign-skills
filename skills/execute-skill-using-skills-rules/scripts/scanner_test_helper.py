...
def execute_skill_using_skills_rules_scripts() -> Path:
...
def story_graph_ops_scripts() -> Path:
    ...
    return execute_skill_using_skills_rules_scripts().parent.parent / "story-graph-ops" / "scripts"
...
def _scanner_pythonpath_parts(
    ...
    *,
    ...
    er = execute_skill_using_skills_rules_scripts()
    if ops.is_dir():
