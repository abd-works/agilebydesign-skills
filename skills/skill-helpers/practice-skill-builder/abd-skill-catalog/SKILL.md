...
| **Hub / grid intros** | HTML fragments | `skills/abd-practice-skill-builder/abd-skill-catalog/templates/intros/*.html` (short lines above grids; optional polish) |
...
1. **Regenerate on command.** From the **agilebydesign-skills** repository root,
   ...
   ```bash
   python skills/abd-practice-skill-builder/abd-skill-catalog/scripts/generate_abd_catalog.py
   ```
   ...
   ```bash
   python skills/abd-practice-skill-builder/abd-skill-catalog/scripts/generate_abd_catalog.py --scaffold-readmes
   ```
...
5. **Catalogue intros (review with an AI or editor).** Short HTML above the
   grids lives in `skills/abd-practice-skill-builder/abd-skill-catalog/templates/intros/`. Keep copy
...
7. **Templates (layout).** HTML shells and CSS live under
   `skills/abd-practice-skill-builder/abd-skill-catalog/templates/` (excluding `intros/`, which are prose
