...
**Purpose:** When output is wrong, **do not edit the source** until the **correct output** is confirmed. Record each problem here first; complete the **fix the output** loop before the optional **improve the source** step. Full narrative: [**SKILL.md**](../SKILL.md).
...
- `logs/corrections-log.md`
- `.corrections/corrections-log.md`
...
When the regenerated output is right: set **Status** to **confirmed**, fill **Example (correct)**, then you may optionally improve the source (see [**SKILL.md**](../SKILL.md) **Improve the source**).
