...
| --- | -------------------------- | ---------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------- |
| 1   | Discovery → Prioritization | Only stories touching SSO or billing           | Per-story                                 | Map proprietary integration surface; capture unknowns before implementation |
| 2   | Exploration → Engineering  | Thin slice 1: one story through SSO + billing  | Per-AC / per-test                         | Prove spec → test → code against Acme SSO; land contract tests             |
