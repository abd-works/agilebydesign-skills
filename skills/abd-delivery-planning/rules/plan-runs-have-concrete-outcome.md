...
| 2 | Exploration → Engineering | Thin slice 1: one SSO story end-to-end | Per-AC / per-test | Prove spec → test → code against Acme SSO; land contract tests for undocumented endpoints |
