#!/usr/bin/env python3
"""Migrated from agile_bots `src/scanners/verb_noun_scanner.py` for exploration AC naming."""
...
from story_map import Epic, Story, StoryNode, SubEpic  # noqa: E402
from story_scanner import StoryScanner  # noqa: E402

from vocabulary_helper import VocabularyHelper  # noqa: E402
...
if __name__ == "__main__":
    sys.exit(main_with_scanner(VerbNounScanner, rule_md_name="use-verb-noun-format-for-story-elements"))
