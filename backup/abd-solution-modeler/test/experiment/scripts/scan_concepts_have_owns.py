...
Rule file: test/experiment/rules/concepts-must-have-owns.md
...
Usage (standalone):
    python test/experiment/scripts/scan_concepts_have_owns.py [--input <path>]
...
def main() -> int:
    ...
    print(f"  Rule: test/experiment/rules/concepts-must-have-owns.md\n")
    for v in violations:
