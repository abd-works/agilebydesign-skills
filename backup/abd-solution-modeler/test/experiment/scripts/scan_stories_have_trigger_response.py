...
Rule file: test/experiment/rules/stories-must-have-trigger-response.md
...
Usage (standalone):
    python test/experiment/scripts/scan_stories_have_trigger_response.py [--input <path>]
...
def main() -> int:
    ...
    print(f"  Rule: test/experiment/rules/stories-must-have-trigger-response.md\n")
    for v in violations:
