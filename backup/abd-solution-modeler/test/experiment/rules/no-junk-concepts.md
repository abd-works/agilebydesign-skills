...
phases: [step1]
order: 40
scanner: scan_no_junk_concepts.py
impact: HIGH
---
...
The scanner (`scan_no_junk_concepts.py`) flags concept names that match known bad patterns. It does not determine whether a specific name is valid — names that are borderline or context-dependent require AI judgment.
