...
phases: [step1]
order: 30
scanner: scan_epic_requires_confirming_stories.py
impact: HIGH
---
...
The scanner (`scan_epic_requires_confirming_stories.py`) highlights epics with fewer than two confirming stories. It does not determine what the missing stories should be — that judgment belongs to the AI.
