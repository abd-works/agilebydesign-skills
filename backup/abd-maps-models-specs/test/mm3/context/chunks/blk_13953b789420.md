...
modeling_kind: rule
---
<!-- Source: docs/HeroesHandbook.md, section 1512 | file:///C:/dev/agilebydesign-skills/skills/abd-maps-models-specs/test/mm3/docs/HeroesHandbook.md -->
...
MUTANTS  &  MASTERMINDS  terms.  For  example,  a  super-wizard  can  do  practically  anything  with  magic.  However,  generally
