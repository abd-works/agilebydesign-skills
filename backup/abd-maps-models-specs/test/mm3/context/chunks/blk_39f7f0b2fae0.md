...
modeling_kind: rule
---
<!-- Source: docs/HeroesHandbook.md, section 1962 | file:///C:/dev/agilebydesign-skills/skills/abd-maps-models-specs/test/mm3/docs/HeroesHandbook.md -->

LASTING INJURIES

MUTANTS & MASTERMINDS is designed to emulate the superhero comic books, so characters generally bounce back pretty fast
